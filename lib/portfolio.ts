...
export const portfolio = {
  ...
  aboutFacts: [
    ...
    { label: "role", value: "Software Engineer", comment: "frontend & flutter" },
    { label: "based in", value: "Kushtia, Dhaka, Bangladesh", comment: "remote-friendly" },
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Contributed frontend development for a confidential e-learning platform, implementing interactive lesson interfaces.",
  ...
  skills: [
    { label: "Languages", items: ["JavaScript (ES6+)", "TypeScript", "Dart", "HTML5", "CSS3"] },
    { label: "Frontend", items: ["React.js", "Next.js", "Tailwind CSS", "Material UI", "ShadCN UI", "Chakra UI", "Radix UI", "Responsive Design", "Semantic HTML"] },
    { label: "Mobile & State", items: ["Flutter", "Riverpod", "React Context API"] },
    { label: "Backend & APIs", items: ["Firebase", "Firestore", "Supabase", "REST APIs"] },
    { label: "Architecture", items: ["Component-Based Design", "Reusable Components", "Clean Architecture", "MVVM", "Repository Pattern"] },
    { label: "Quality", items: ["Performance Optimization", "Code Splitting", "Lazy Loading", "Debugging", "Cross-Browser Compatibility", "Accessibility (WCAG Basics)"] },
    { label: "Tools", items: ["Git", "GitHub", "VS Code", "Postman", "Firebase Hosting", "Vercel", "npm", "pnpm"] },
    { label: "AI & Productivity", items: ["GitHub Copilot", "ChatGPT", "Prompt Engineering", "AI-assisted Software Development"] },
  ],
